	...
	return (
		<aside className="w-80 bg-white border-r border-gray-200 overflow-y-auto no-print p-4 flex flex-col gap-6 shadow-lg z-10">
			...
			<div className="flex flex-row gap-3 mt-auto pt-4">
				...
				<div className="flex justify-center">
					<a
						href="https://github.com/nasanov/vision-trainer-pattern-generator"
						target="_blank"
						rel="noopener noreferrer"
						className="flex items-center gap-2 px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors shadow-md"
					>
						<Github size={20} />
					</a>
				</div>
